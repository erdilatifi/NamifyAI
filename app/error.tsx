  ...
  return (
    <div className="relative min-h-[calc(100vh-6rem)] bg-background pt-24">
      ...
      <div className="relative mx-auto w-full max-w-xl px-6 py-20 text-center">
        ...
        <h1 className="mt-3 text-3xl font-semibold tracking-tight text-zinc-50">Unexpected error</h1>
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          ...
          <Button
            type="button"
            variant="outline"
            className="border-white/15 bg-white/[0.06] text-zinc-50 hover:bg-white/10"
