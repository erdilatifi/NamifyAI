  ...
  return (
    <div className="relative min-h-[calc(100vh-6rem)] bg-background pt-24">
      ...
      <div className="relative mx-auto w-full max-w-xl px-6 py-20 text-center">
        <div className="text-sm text-zinc-400">Payment canceled</div>
        <h1 className="mt-3 text-3xl font-semibold tracking-tight text-zinc-50">No worries</h1>
        <p className="mt-3 text-sm leading-6 text-zinc-300">You can upgrade anytime from your billing page.</p>
